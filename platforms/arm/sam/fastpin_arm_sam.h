...
#define MAX_PIN 17
_DEFPIN_DUE(0, 2, B); _DEFPIN_DUE(1, 3, B); _DEFPIN_DUE(2, 1, B); _DEFPIN_DUE(3, 0, A);
_DEFPIN_DUE(4, 1, A); _DEFPIN_DUE(5, 9, A); _DEFPIN_DUE(6, 20, A); _DEFPIN_DUE(7, 10, A);
_DEFPIN_DUE(8, 8, A); _DEFPIN_DUE(9, 7, A); _DEFPIN_DUE(10, 6, A); _DEFPIN_DUE(11, 3, A);
_DEFPIN_DUE(12, 4, A); _DEFPIN_DUE(13, 13, A); _DEFPIN_DUE(14, 12, A); _DEFPIN_DUE(15, 14, A);
_DEFPIN_DUE(16, 11, A); _DEFPIN_DUE(17, 15, A);
...
#endif // due pins // digix pins // motionbows pins
